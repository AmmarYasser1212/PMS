        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FocusTime = table.Column<int>(type: "int", nullable: true),
                    CompletedTasks = table.Column<int>(type: "int", nullable: true),
                    PendingTasks = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    EnableMotivation = table.Column<bool>(type: "bit", nullable: false),
                    EnableReminders = table.Column<bool>(type: "bit", nullable: false),
                    EnableAiTips = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedTasks = table.Column<int>(type: "int", nullable: false),
                    ProductivityScore = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProductivityStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserProductivityStats_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProductivityStats_UserId",
                table: "UserProductivityStats",
                column: "UserId");
